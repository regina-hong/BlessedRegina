...
//echo $verb_actual_word.'<br>';
	...
	if ($pre_org == 'לְ' || $pre_org == 'לִ' || $pre_org == 'לֲ' || $pre_org == 'לַֽ' || $pre_org == 'לָ' || $pre_org == 'לְ' || $pre_org == 'מֵֽ' || $pre_org == 'מִ' || $pre_org == 'בְּ' || $pre_org == 'לֶ' || $pre_org =='מֵ' || $pre_org =='לַ' || $pre_org == 'בִּ' || $pre_org == 'בְ' || $pre_org == 'בִּֽ' || $pre_org == 'לִֽ' || $pre_org == 'לֶֽ' || $pre_org == 'בַּ' || $pre_org == 'מִֽ' || $pre_org == 'מֵֽ' || $pre_org == 'בֶּ' || $pre_org == 'לְֽ' || $pre_org == 'לַ֠' || $pre_org == 'לֶֽ' || $pre_org == 'בִּ֠' || $pre_org == 'בְּ֠' || $pre_org =='לְ֠' ||  $pre_org =='לָ֣' || $pre_org == 'בְּֽ') {
	...
	} elseif ($pre_org == 'הָ' || $pre_org == 'הַ' || $pre_org == 'הַֽ' || $pre_org == 'הֶ' || $pre_org == 'הֲ' || $pre_org == 'הַֽ' || $pre_org == 'הָֽ' || $pre_org == 'הֶֽ' || $pre_org == 'הַ֨' || $pre_org == 'הַ') {
		if ($verb_actual_word == 'מְּחֻקֶּה') {
			$verb_tense = 'Pual/Participle';
		} elseif ($verb_actual_word == 'מּוּבָא') {
			$verb_tense = 'Hophal/Pass Part';
		} elseif ($firstletter_a == 'נ' && $verb_type <> 'Weak<br>I-Nun') {
...
//echo $verb_actual_word.'<br>';
		...
		//Exceptions
		if ($verb_actual_word == 'שְלַח' || $verb_actual_word == 'סְלַח' || $verb_actual_word == 'בְקָעֵ' || $verb_actual_word == 'שְמַע' || $verb_actual_word =='שְאַל' || $verb_actual_word == 'שֲמָע') {
			$verb_tense = 'Qal/Imperative';
			$verb_pgn = '2.m.s';
		} elseif ($verb_actual_word == 'שְלָחוּ') {
			$verb_tense = 'Qal/Imperative';
			$verb_pgn = '2.m.p';
		} elseif ($verb_actual_word == 'מֵאַנְתָּ' || $verb_actual_word == 'מָאַסְתָּה') {
			$verb_tense = 'Qal/Perfect';
			$verb_pgn = '2.m.s';
		} elseif ($verb_actual_word == 'גְּמָלַתּ') {
			$verb_tense = 'Qal/Perfect';
			$verb_pgn = '2.f.s';
		} elseif ($verb_actual_word == 'מְצָאָ' || $verb_actual_word == 'תְפָשָ' || $verb_actual_word == 'שְנֵאָ' || $verb_actual_word == 'שִלְּחָ' || $verb_actual_word == 'תֻּמָּ' || $verb_actual_word == 'זָקַנְתָּה'  || $verb_actual_word == 'גָּמְלָ' || $verb_actual_word == 'שְפָטָ') {
			$verb_tense = 'Qal/Perfect';
			$verb_pgn = '3.m.s';
		} elseif ($verb_actual_word == 'הִשְלִיכָ') {
			$verb_tense = 'Hiphil/Perfect';
			$verb_pgn = '3.m.s';
		} elseif ($verb_actual_word == 'שַכֹּתִי' || $verb_actual_word == 'גְּמַלְתִּי') {
			$verb_tense = 'Qal/Perfect';
			$verb_pgn = '1.c.s';
		} elseif ($verb_actual_word == 'גְּנָבָתַ') {
			$verb_tense = 'Qal/Perfect';
			$verb_pgn = '3.f.s';
		} elseif ($verb_actual_word == 'סִקְלֻ') {
			$verb_tense = 'Qal/Perfect';
			$verb_pgn = '3.m.p';
		} elseif ($verb_actual_word == 'תִּלְקְטֻ') {
			$verb_tense = 'Qal/Imerfect';
			$verb_pgn = '2.m.p';
		} elseif ($verb_actual_word == 'הִמְצִיתִ') {
			$verb_tense = 'Hiphil/Perfect';
			$verb_pgn = '1.c.s';
		} elseif ($verb_actual_word == 'נִזְבְּחָה' || $verb_actual_word == 'נִשְמָעָה' || $verb_actual_word == 'נַשְלִכֵ' || $verb_actual_word == 'נִשְמָעֶ' || $verb_actual_word == 'נִשְלְחָה' || $verb_actual_word == 'נִשְמְעָה' || $verb_actual_word == 'נִתְפְּשֵ') {
		...
		//verb has no prefix
			...
			if ($firstvowel_a == 'ְ' && $thirdvowel_a == 'ֹ') {
				...
				$verb_tense = 'Pual/Participle';
			} elseif ($firstvowel_a == 'ְ' || ($firstvowel_a == 'ּ' && $secondvowel_a == 'ְ') || ($firstvowel_a == 'ּ' && $secondvowel_a == 'ִ' && $fourthvowel_a == 'ְ')) {
				$verb_tense = 'Qal/Imperative';
		...
		//verb has prefix
			...
			//	$verb_tense = 'Qal/Cohortative';
			//	$verb_pgn = 'p';
			} elseif ($firstletter_a == 'נ' && $firstvowel_a == 'ּ' && $secondvowel_a == 'ִ' && $fourthvowel_a == 'ּ' && $fifthvowel_a == 'ָ') {
				$verb_tense = 'Niphal/Imperfect';
			} elseif (($firstletter_a == 'נ' && $firstvowel_a == 'ִ') || ($firstletter_a == 'נ' && $firstvowel_a == 'ּ' && $secondvowel_a == 'ִ')) {
			...
			} elseif (($firstvowel_a == 'ְ' && $thirdvowel_a == 'ֻ') || $firstvowel_a == 'ֻ') {
			...
			} elseif (($firstvowel_a == 'ִ' && $thirdvowel_a == 'ְ') || $firstvowel_a == 'ֵ') {
				$verb_tense = 'Hiphil/Perfect';				
			} elseif ($firstvowel_a == 'ָ') {
...
//echo $verb_actual_word.'<br>';
		...
		//Exceptions
		if ($verb_actual_word == 'אֲחַלְּקֵ' || $verb_actual_word == 'אַהַרְגָה' || $verb_actual_word == 'אֶרְדְּפָה' ) {
			$verb_tense = 'Qal/Cohortative';
			$verb_pgn = 's';
		} elseif ($verb_actual_word == 'נַהַרְגֵ' || $verb_actual_word == 'נַעַבְדָה' || $verb_actual_word == 'נַעְבְּרָה' || $verb_actual_word == 'נִתְחַזַּק' || $verb_actual_word == 'נֶחֱזַק') {
			$verb_tense = 'Qal/Cohortative';
			$verb_pgn = 'p';
		} elseif ($verb_actual_word == 'רַחֲצוּ' || $verb_actual_word == 'רַגְּלוּ' || $verb_actual_word == 'חַפְּשוּ') {
			$verb_tense = 'Qal/Imperative';
			$verb_pgn = '2.m.p';
		} elseif ($verb_actual_word == 'חֲזַק' || $verb_actual_word == 'לֵךְ') {
			$verb_tense = 'Qal/Imperative';
			$verb_pgn = '2.m.s';
		} elseif ($verb_actual_word == 'עֲזָרָ') {
			$verb_tense = 'Qal/Perfect';
			$verb_pgn = '3.m.s';
		} elseif ($verb_actual_word == 'הִרְגַּזְתַּ') {
			$verb_tense = 'Hiphil/Perfect';
			$verb_pgn = '2.m.s';
		} elseif ($verb_actual_word == 'הֶחֱטֵיאָ') {
			$verb_tense = 'Hiphil/Imerfect';
			$verb_pgn = '3.m.s';
		} elseif ($verb_actual_word == 'חַלֵּק') {
			$verb_tense = 'Piel/Imperative';
			$verb_pgn = '2.m.s';
		} elseif ($verb_actual_word == 'הַחֲרַמְתִּי') {
			$verb_tense = 'Hiphil/Perfect';
			$verb_pgn = '1.c.s';
		} elseif ($verb_actual_word == 'נַחְבֵּאתָ') {
			$verb_tense = 'Niphal/Perfect';
			$verb_pgn = '2.m.s';
		} elseif ($verb_actual_word == 'חַם' || $verb_actual_word == 'רַעֲנָן') {
			$verb_tense = 'Qal/Participle';
		} elseif ($verb_actual_word == 'חַזֵּק') {
			$verb_tense = 'Qal/Imperative/Act Participle';
			$verb_pgn ='';	
		...
		//verb has prefix
			...
			if (($firstletter_a == 'י' && $firstvowel_a == 'ִ' && $secondvowel_a == 'ת' && $thirdvowel_a == 'ְ') || ($firstletter_a == 'י' && $secondvowel_a == 'ִ' && $thirdvowel_a == 'ת' && $fourthvowel_a == 'ְ') || ($firstletter_a == 'ת' && $firstvowel_a == 'ּ' && $secondvowel_a == 'ִ' && $thirdvowel_a == 'ת' && $fourthvowel_a == 'ְ')) {
...
//echo $verb_actual_word.'<br>';
		...
		//Exceptions
		if ($verb_actual_word == 'קרואי' || $verb_actual_word == 'פֹּרְשֵי' || $verb_actual_word == 'בְּחוּרֵי' || $verb_actual_word == 'קְרוּעֵי') {
			$verb_tense = 'Qal/Participle';
			...
			$verb_tense = 'Hiphil/Perfect';
			$verb_pgn = '2.m.s';
		} elseif ($verb_actual_word == 'בֵרֵאת') {
			$verb_tense = 'Piel/Perfect';
			$verb_pgn = '2.m.s';
		} elseif ($verb_actual_word == 'קָרְאֵ') {
			$verb_tense = 'Qal/Perfect';
			$verb_pgn = '3.m.s';
		} elseif ($verb_actual_word == 'זָרְחָה') {
			$verb_tense = 'Qal/Perfect';
			$verb_pgn = '3.f.s';
		} elseif ($verb_actual_word == 'נִקְרַב') {
			$verb_tense = 'Qal/Imerfect/Niphal/Perfect';
			$verb_pgn = '1.c.p/3.m.s';
		} elseif ($verb_actual_word == 'שָרְפוּ') {
			$verb_tense = 'Piel/Perfect';
			$verb_pgn = '3.m.p';
		} elseif ($verb_actual_word == 'סְחָרוּ' || $verb_actual_word == 'בָּרֲכֵ') {
			$verb_tense = 'Qal/Imperative';
			$verb_pgn = '2.m.p';
		} elseif ($verb_actual_word == 'קְרָא') {
			$verb_tense = 'Qal/Imperative';
			$verb_pgn = '2.m.s';
		} elseif ($verb_actual_word == 'בָרֵךְ') {
			$verb_tense = 'Qal/Imperative/Perfect';
			$verb_pgn = '';
			...
			$verb_tense = 'Qal/Cohortative';
			$verb_pgn = 's';
		} elseif ($verb_actual_word == 'נִקְרְבָה' || $verb_actual_word == 'נִלָּחֵם' || $verb_actual_word == 'נִדְרְשָה') {
			$verb_tense = 'Qal/Cohortative';
			$verb_pgn = 'p';
		} elseif ($verb_actual_word == 'נִלָּחֲמָה') {
			$verb_tense = 'Niphal/Cohortative';
			$verb_pgn = 'p';
		...
		//verb has no prefix
			...
			}elseif ($firstvowel_a == 'ְ' && $thirdvowel_a == 'ַ' && $firstvowel_l <> 'ם' && $secondvowel_l <> 'ֶ' && $thirdvowel_l <> 'ּ' & $fourthvowel_l <> 'ת' ) {
				$verb_tense = 'Qal/Imperative';		
			} elseif ($firstvowel_a == 'ָ' && $thirdvowel_a == 'ְ') {
				$verb_tense = 'Piel/Imperative';
		...
		//verb has prefix
			...
			if ($firstvowel_a == 'ְ' && $thirdvowel_a == 'ָ') {
				...
				$verb_tense = 'Pual/Imperfect';
			} elseif ($firstletter_a == 'נ' && $firstvowel_a == 'ִ' && $thirdvowel_a == 'ְ' && $fifthvowel_a == 'ָ' && $firstvowel_l <> 'ּ' && $secondvowel_l <> 'ו') {
				$verb_tense = 'Niphal/Pass Part';
			} elseif ($firstletter_a == 'נ' && $firstvowel_a == 'ִ' && $thirdvowel_a == 'ְ' && $fifthvowel_a == 'ֹ') {
				$verb_tense = 'Qal/Imperfect';
...
//echo $verb_actual_word.'<br>';
		...
		if ($verb_actual_word == 'אֶסְפָ') {
			...
			$verb_tense = 'Qal/Perfect';
			$verb_pgn = '3.f.s';
		} elseif ($verb_actual_word == 'אִבְּדָ' || $verb_actual_word == 'אִבַּד') {
			$verb_tense = 'Qal/Perfect';
			$verb_pgn = '3.m.s';
		} elseif ($verb_actual_word == 'אֲכַלֵּ') {
			$verb_tense = 'Qal/Imperfect';
			$verb_pgn = '1.c.s';
		} elseif ($verb_actual_word == 'נֹּאכְלֵ' || $verb_actual_word == 'נֹאכְלֶ') {
			$verb_tense = 'Qal/Imperfect';
			$verb_pgn = '1.c.p';
		} elseif ($verb_actual_word == 'אֹבַד') {
			$verb_tense = 'Qal/Act Part';
		} elseif ($verb_actual_word == 'אֱמֹר') {
			$verb_tense = 'Qal/Imperative/Inf Cs';
		} elseif ($verb_actual_word == 'נֹאחֲזוּ') {
			$verb_tense = 'Niphal/Perfect';
			$verb_pgn = '3.m.p';
		} elseif ($verb_actual_word == 'הַאֲזִינוּ') {
			$verb_tense = 'Hiphil/Imperative';
			$verb_pgn = '2.m.p';

		//verb has no prefix
		} elseif (($firstletter == $firstletter_a) && ($firstletter_a <> $thirdvowel_a)) {
			if ($firstvowel_a == 'ָ' || ($firstvowel_a == 'ּ' && $secondvowel_a == 'ָ') || $firstvowel_a == 'ֲ' || $firstvowel_a == 'ֵ') {
				if ($thirdvowel_a == 'ו'  && $fourthvowel_a == 'ּ') {
					$verb_tense = 'Qal/Pass Part';
				} elseif (($thirdvowel_a == 'ֹ') || ($thirdvowel_a == 'ו'  && $fourthvowel_a == 'ֹ')) {
					$verb_tense = 'Qal/Inf Abs';
...
//echo $verb_actual_word.'<br>';
		...
		if ($verb_actual_word == 'נָתַתָּה' || $verb_actual_word == 'נָשָאתָה') {
			$verb_tense = 'Qal/Perfect';
			$verb_pgn ='2.m.s';	
		} elseif ($verb_actual_word == 'קְחַת') {
			$verb_tense = 'Qal/Act Participle';
			$verb_pgn ='';	
		} elseif ($verb_actual_word == 'נִצָּב') {
			$verb_tense = 'Niphal/Perfect/Pass Participle';
			$verb_pgn ='3.m.s';
		} elseif ($verb_actual_word == 'הִגַּדְתָּה') {
			$verb_tense = 'Hiphil/Perfect';
			$verb_pgn ='2.m.s';
		} elseif ($verb_actual_word == 'הִלָּקַח' || $verb_actual_word == 'הִשִּגָ' ) {
			$verb_tense = 'Hiphil/Perfect';
			$verb_pgn ='3.m.s';
		} elseif ($verb_actual_word == 'לְקַחְתִּי') {
			$verb_tense = 'Qal/Perfect';
			$verb_pgn ='1.c.s';
		} elseif ($verb_actual_word == 'נְתָנָ') {
			$verb_tense = 'Qal/Perfect';
			$verb_pgn ='3.m.s';
		} elseif ($verb_actual_word == 'נִּקַּח' || $verb_actual_word == 'נִּתְּנָ' || $verb_actual_word == 'נַגִּידָה') {
			$verb_tense = 'Qal/Imperfect';
			$verb_pgn ='1.c.p';
		} elseif ($verb_actual_word == 'תְּנוּ' || $verb_actual_word == 'תְנוּ' || $verb_actual_word == 'נִטְעוּ') {
			$verb_tense = 'Qal/Imperative';
			$verb_pgn ='2.m.p';
		} elseif ($verb_actual_word == 'נָשֹא' || $verb_actual_word == 'תְּנִי' || $verb_actual_word == 'תְּנָ' || $verb_actual_word == 'נָקְבָ') {
			$verb_tense = 'Qal/Imperative';
			$verb_pgn ='2.m.s';
		} elseif ($verb_actual_word == 'תֵּת' || $verb_actual_word == 'שְאֵת' || $verb_actual_word == 'נשאי') {
			$verb_tense = 'Qal/Inf Cs';
		} elseif ($verb_actual_word == 'נְתוּנִם') {
			$verb_tense = 'Qal/Participle';
			$verb_pgn ='m.p';
		} elseif ($verb_actual_word == 'נִסְעָה' || $verb_actual_word ==  'נִנְחַל' || $verb_actual_word == 'נִפְּלָה') {
			$verb_tense = 'Qal/Cohortative';
			$verb_pgn ='p';
		...
		//verb has prefix
			...
			if ($firstvowel_a == 'ַ' && $thirdvowel_a == 'ּ' && $fourthvowel_a == 'ֵ') {
				$verb_tense = 'Hiphil/Jussive';
			} elseif ($firstvowel_a == 'ַ' || ($firstvowel_a == 'ּ' && $secondvowel_a == 'ַ')) {
				$verb_tense = 'Hiphil/Imperfect';
			} elseif ($firstvowel_a == 'ֻ' || $secondvowel_a == 'ֻ' ) {
				...
				$verb_tense = 'Hithpael/Imperfect';
			} elseif ($firstletter_a == 'י' && $firstvowel_a == 'ּ' && $secondvowel_a == 'ִ' && $thirdvowel_a == 'ת' && $fourthvowel_a == 'ְ') {
				$verb_tense = 'Hithpael/Imperfect';
			} elseif ($firstletter_a == 'א' && $firstvowel_l == 'ה' && $secondvowel_l == 'ָ') {
				$verb_tense = 'Qal/Cohortative';
			} elseif ($firstvowel_a == 'ְ' && $thirdvowel_a == 'ַ') {
...
//echo $verb_actual_word.'<br>';
		...
		//Exceptions
		if ($verb_actual_word == 'צֵאת' || $verb_actual_word == 'צֵאתְ' || $verb_actual_word == 'יוֹשְבֵי' ) {
			$verb_tense = 'Qal/Inf Cs';
			$verb_pgn = 'm.s';
		} elseif ($verb_actual_word == 'דַּעְתִּ' || $verb_actual_word == 'יוֹדַעְתִּי' ) {
			$verb_tense = 'Qal/Perfect';
			$verb_pgn = '1.c.s';
		} elseif ($verb_actual_word == 'יֹּרִדֵ' ) {
			$verb_tense = 'Qal/Imerfect';
			$verb_pgn = '3.m.s';
		} elseif ($verb_actual_word == 'נוֹדִיעָה') {
			$verb_tense = 'Hiphil/Imperfect';
			$verb_pgn = '1.c.p';
			$verb_type = 'Weak<br>I-Waw';
		} elseif ($verb_actual_word == 'יוֹשֶבֶת') {
			$verb_tense = 'Qal/Perfect';
			$verb_pgn = '3.f.s';
		} elseif ($verb_actual_word == 'יוֹשֵב') {
			$verb_tense = 'Qal/Inf Abs';
			$verb_type = 'Weak<br>I-Waw';
		} elseif ($verb_actual_word == 'נֵלֵכָה' || $verb_actual_word == 'נֵלְכָה') {
			$verb_tense = 'Qal/Cohortative';
			$verb_pgn = 'p';
		} elseif ($verb_actual_word == 'נּוֹרָא' || $verb_actual_word == 'נִצְּתָה') {
			$verb_tense = 'Niphal/Perfect';
			$verb_pgn ='3.m.s';
		} elseif ($verb_actual_word == 'הוֹרָ') {
			$verb_tense = 'Hiphil/Perfect';
			$verb_pgn ='3.m.s';
		...
		//verb has no prefix
			...
			if ($firstvowel_a == 'ָ' || ($firstvowel_a == 'ּ' && $secondvowel_a == 'ָ') || $firstvowel_a == 'ְ' || ($firstvowel_a == 'ִ' && $firstvowel_l == 'י')) {
				...
				$verb_tense = 'Niphal/Imperfect';
				$verb_type = 'Weak<br>I-Waw';
			} elseif (($secondvowel_a == 'ִ' && $fourthvowel_a == 'ְ') ||($firstvowel_a == 'ִ' && $thirdvowel_a == 'ָ')) {
				$verb_tense = 'Qal/Perfect';
		...
		//verb has prefix			
			...
			if ($secondvowel_a == 'ּ' && $fourthvowel_a == 'ַ' || $fourthvowel_a == 'ְ') {
				...
				$verb_tense = 'Hiphil/Imperative';
		} elseif ($firstletter_a == 'ה' && ($firstvowel_a == 'ִ') || ($firstvowel_a == 'ֹ')) {
				$verb_tense = 'Hiphil/Perfect';
...
//echo $verb_actual_word.'<br>';
		...
		} elseif ($verb_actual_word == 'הָיִיתָה') {
			$verb_tense = 'Qal/Perfect';
			$verb_pgn = '2.m.s';
		} elseif ($verb_actual_word == 'הֱיוֹת') {
			$verb_tense = '??';
			$verb_pgn = '??';
		}
...
//echo $verb_actual_word.'<br>';
		...
		//Exceptions
		if ($verb_actual_word == 'הִזָּה' || $verb_actual_word == 'הִכָּ' || $verb_actual_word == 'הִכִּית' ) {
			$verb_tense = 'Hiphil/Perfect';
			$verb_pgn = '3.m.s';
		} elseif ($verb_actual_word == 'הִכִּיתָה') {
			$verb_tense = 'Hiphil/Perfect';
			$verb_pgn = '2.m.s';
		} elseif ($verb_actual_word == 'צַוֺּת' || $verb_actual_word == 'בְּכִי') {
			$verb_tense = 'Qal/Participle';
			$verb_pgn = 'm.s';
		} elseif ($verb_actual_word == 'ישתחו') {
			$verb_tense = 'Qal/Imperfect';
			$verb_pgn = '3.m.p';
		} elseif ($verb_actual_word == 'בָּנוּ') {
			$verb_tense = 'Qal/Imperative/Perfect';
			$verb_pgn = '2.m.p/3.m.p';
		} elseif ($verb_actual_word == 'בָּלוּ' || $verb_actual_word == 'בָּכוּ') {
			$verb_tense = 'Qal/Perfect';
			$verb_pgn = '3.m.p';
		} elseif ($verb_actual_word == 'נִשְתֶּה') {
			$verb_tense = 'Qal/Imperfect';
			$verb_pgn = '1.c.p';
		} elseif ($verb_actual_word == 'אֶבְכֶּה') {
			$verb_tense = 'Qal/Imperfect';
			$verb_pgn = '1.c.s';
			...
			$verb_tense = 'Qal/Perfect';
			$verb_pgn = '3.m.s';
		} elseif ($verb_actual_word == 'בָּנִתָה') {
			$verb_tense = 'Qal/Perfect';
			$verb_pgn = '2.m.s';
		} elseif ($verb_actual_word == 'הֶחֱשוּ') {
			$verb_tense = 'Hiphil/Imperative';
			$verb_pgn = '2.m.p';
		} elseif ($verb_actual_word == 'בְּנֵה') {
			$verb_tense = 'Qal/Imperative';
			$verb_pgn = '2.m.s';
		} elseif ($verb_actual_word == 'עֲלוּ' || $verb_actual_word == 'עֱנוּ' || $verb_actual_word == 'צַוּוּ' ) {
			$verb_tense = 'Qal/Imperative';
			$verb_pgn = '2.m.p';
		} elseif ($verb_actual_word == 'עֲשִי' || $verb_actual_word == 'רְאִי') {
			$verb_tense = 'Qal/Imperative';
			$verb_pgn = '2.f.s';
		} elseif ($verb_actual_word == 'עֲלִי') {
			$verb_tense = 'Piel/Imperative';
			$verb_pgn = '2.f.s';
		} elseif ($verb_actual_word == 'תְּצַוֻּ') {
			$verb_tense = 'Piel/Imperfect';
			$verb_pgn = '2.m.p';
		} elseif ($verb_actual_word == 'רִמִּיתִ') {
			$verb_tense = 'Piel/Perfect';
			$verb_pgn = '2.f.s';
		} elseif ($verb_actual_word == 'כַּלּוֹתָ') {
			$verb_tense = 'Piel/Inf Cs';
			$verb_pgn = '';
		} elseif ($verb_actual_word == 'רָאִיתָה' || $verb_actual_word == 'צִוִּיתָה' || $verb_actual_word == 'עָשִיתָה' || $verb_actual_word == 'גָּלִיתָה') {
			$verb_tense = 'Qal/Perfect';
			$verb_pgn = '2.m.s';
		} elseif (($firstvowel_l == 'ם' && $secondvowel_l == 'י') || ($firstvowel_l == 'ת' && $secondvowel_l == 'ֹ' && $thirdvowel_l == 'ו')) {
			if ($firstletter_a == 'ה') {
			...
			$verb_tense = 'Piel/Cohortative';
			$verb_pgn = 's';
		} elseif ($verb_actual_word == 'נַכֶּ' || $verb_actual_word == 'נִּשְתֶּה' || $verb_actual_word == 'נִתְרָאֶה') {
			$verb_tense = 'Qal/Cohortative';
			$verb_pgn = 'p';
		} elseif ($verb_actual_word == 'אַנְוֵ') {
			$verb_tense = 'Qal/Cohortative';
			$verb_pgn = 's';
		} elseif ($verb_actual_word == 'נֶעֶשְתָה') {
			$verb_tense = 'Qal/Cohotative/Niphal/Perfect';
			$verb_pgn = 's/3.f.s';
		...
		//verb has no prefix
			...
			if (($firstvowel_l == 'ם' && $secondvowel_l == 'י') || ($firstvowel_l == 'ת' && $secondvowel_l == 'ֹ' && $thirdvowel_l == 'ו')) {
				...
				if ($thirdvowel_a == 'ֹ') {
					...
					$verb_tense = 'Qal/Inf Cs';		
				} elseif ($firstvowel_l == 'ּ' && $secondvowel_l == 'ו' && $firstvowel_a <> 'ָ') {
					$verb_tense = 'Qal/Imperative';
		...
		//verb has prefix
			...
			if ($firstletter_a == 'נ' && $firstvowel_a == 'ַ' && $thirdvowel_a == 'ְ') {
				$verb_tense = 'Niphal/Perfect';
			} elseif ($firstvowel_a == 'ַ' || ($firstvowel_a == 'ּ' && $secondvowel_a == 'ַ')) {
				$verb_tense = 'Hiphil/Imperfect';
				...
				$verb_tense = 'Hophal/Imperfect';
			} elseif (($firstvowel_a == 'ְ' && $thirdvowel_a == 'ַ') || ($firstletter_a == 'ת' && $firstvowel_a == 'ּ' && $secondvowel_a == 'ְ' && $fourthvowel_a == 'ַ')) {
				$verb_tense = 'Piel/Imperfect';
			} elseif ($firstvowel_a == 'ְ' && $thirdvowel_a == 'ֻ') {
				$verb_tense = 'Pual/Imperfect';
			} elseif (($firstvowel_a == 'ִ' && $thirdvowel_a == 'ּ' && $fourthvowel_a == 'ָ')) {
			...
			if ($firstvowel_a == 'ַ') {
				...
				$verb_tense = 'Hiphil/Perfect';			
			} elseif ($firstvowel_a == 'ֶ' || $firstvowel_a == 'ִ' || $firstvowel_a == 'ֹ') {
				$verb_tense = 'Hiphil/Perfect';		
			} elseif ($firstvowel_a == 'ָ') {
				$verb_tense = 'Hophal/Perf/Inf';								
			} else {
...
//echo $verb_actual_word.'<br>';
		...
		if ($verb_actual_word == 'צִוָּה' || $verb_actual_word == 'צִוָּ' || $verb_actual_word == 'הֱוֵה' ) {
			$verb_tense = 'Qal/Perfect';
			$verb_pgn = '3.m.s';
		} elseif ($verb_actual_word == 'יָשֹב') {
			$verb_tense = 'Qal/Jussive';
			$verb_pgn = '3.m.s';
		} elseif ($verb_actual_word == 'מְמִיתִים') {
			$verb_tense = 'Qal/Participle';
		} elseif ($verb_actual_word == 'צִוִּיתִ' || $verb_actual_word == 'צִוִּיתִי') {
			$verb_tense = 'Qal/Perfect';
			$verb_pgn = '1.c.s';
		} elseif ($verb_actual_word == 'הֱסִיתְ') {
			$verb_tense = 'Hiphil/Perfect';
			$verb_pgn = '3.m.s';
		} elseif ($verb_actual_word == 'הֲקֵמֹת') {
			$verb_tense = 'Hiphil/Perfect';
			$verb_pgn = '2.m.s';
		} elseif ($verb_actual_word == 'הֵסַתָּה') {
			$verb_tense = 'Hiphil/Perfect';
			$verb_pgn = '3.f.s';
		} elseif ($verb_actual_word == 'נָנוּס' ) {
			$verb_tense = 'Niphal/Imperfect';
			$verb_pgn = '1.c.p';
		} elseif ($verb_actual_word == 'נָכוֹנָה' ) {
			$verb_tense = 'Niphal/Perfect';
			$verb_pgn = '3.f.s';
			...
			$verb_pgn = '2.m.p';
		} elseif ($verb_actual_word == 'בִּינוּ' || $verb_actual_word == 'פֻּצוּ' || $verb_actual_word == 'סֻּרוּ') {
			$verb_tense = 'Qal/Imperative';
			$verb_pgn = '2.m.p';
			...
			$verb_tense = 'Qal/Inf Abs';
		} elseif (($firstvowel_l == 'ת' && $secondvowel_l == 'ֹ' && $thirdvowel_l == 'ו') || ($firstvowel_l == 'ַ' && $thirdvowel_l == 'ֹ' && $fourthvowel_l == 'ו')) {
			if ($firstletter_a == 'ה') {
				$verb_tense = 'Niphal/Inf Cs';
			} else {				
				$verb_tense = 'Qal/Participle';
		...
		//verb has no prefix
			...
			if (($firstvowel_l == 'ת' && $secondvowel_l == 'ֹ' && $thirdvowel_l == 'ו')) {
				$verb_tense = 'Qal/Participle';			
		...
		//verb has prefix
			...
			if ($firstvowel_a == 'ַ' || ($firstvowel_a == 'ּ' && $secondvowel_a == 'ַ') || ($firstletter_a == 'א' && $firstvowel_a == 'ָ' && $thirdvowel_a == 'ִ' && $fourthvowel_a == 'י')) {
				$verb_tense = 'Hiphil/Imperfect';
			} elseif ($firstletter_a == 'י' && $firstvowel_a == 'ִ' && $secondvowel_a == 'ת' && $thirdvowel_a == 'ְ') {
				$verb_tense = 'Hitpael/Imperfect';	
			...
			if ($firstvowel_a == 'ִ' && $thirdvowel_a == 'ּ') {
				...
				$verb_tense = 'Hophal/Perfect';		
			} elseif ($firstvowel_a == 'ֵ' || $firstvowel_a == 'ֲ' || $firstvowel_a == 'ֱ' || $firstvowel_a == 'ַ' || $firstvowel_a == 'ִ') {
				$verb_tense = 'Hiphil/Perfect';				
			} elseif ($firstvowel_a == 'ָ') {
				$verb_tense = 'Hiphil/Imperative/Inf';					
...
//echo $verb_actual_word.'<br>';
		...
		if ($verb_actual_word == 'קַבֹּת' ) {
			$verb_tense = 'Qal/Perfect';
			$verb_pgn = '2.m.s';
		} elseif ($verb_actual_word == 'פִלְל' ) {
			$verb_tense = 'Qal/Perfect';
			$verb_pgn = '3.m.s';
		} elseif ($verb_actual_word == 'נָמֵס' ) {
			$verb_tense = 'Niphal/Inf';
			$verb_pgn = '';
		} elseif ($verb_actual_word == 'נָבָר' ) {
			$verb_tense = 'Qal/Inf Abs';
			$verb_pgn = '';
		} elseif ($verb_actual_word == 'מִתְמַהְמֵהַּ' ) {
			$verb_tense = 'Hithpael/Participle';
			$verb_pgn = '';
		...
		//verb has prefix
			...
			if ($firstvowel_a == 'ַ' || ($firstvowel_a == 'ּ' && $secondvowel_a == 'ַ')) {
				...
				$verb_tense = 'Hithpael/Imperfect';	
			} elseif ($firstletter_a == 'ת' && $firstvowel_a == 'ּ' && $secondvowel_a == 'ִ' && $thirdvowel_a == 'ת' && $fourthvowel_a == 'ְ') {
				$verb_tense = 'Hithpael/Imperfect';					
			} else {
				$verb_tense = 'Qal/Imperfect';
			}
...
*/
			...
			if ($verb_type == 'Weak<br>III-He' || $verb_type == 'Special<br>Haya') {
				if ($firstvowel_l == 'ם' && $secondvowel_l == 'ֶ' && $thirdvowel_l == 'ת') {
					...
					$verb_pgn = '2.m.s';	
				} elseif (($firstvowel_l == 'ת' && $secondvowel_l == 'י') || $firstvowel_l == 'ת' || ($firstvowel_l == 'ְ' && $secondvowel_l == 'ּ' && $thirdvowel_l == 'ת') || ($firstvowel_l == 'ְ' && $secondvowel_l == 'ת')) {
					$verb_pgn = '2.f.s';	
				} else {
					$verb_pgn = '3.m.s';
				}	
				...
				if ($firstvowel_l == 'ם' && $secondvowel_l == 'ֶ' && (($thirdvowel_l == 'ּ' && $fourthvowel_l == 'ת') || ($thirdvowel_l == 'ת'))) {
					...
					$verb_pgn = '2.m.s';	
				} elseif ($firstvowel_l == 'ה' && $verb_root <> 'היה' && $thirdletter <> 'ה') {
					$verb_pgn = '3.f.s';			
					...
					$verb_pgn = '1.c.p';	
				} elseif ($firstvowel_l == 'ֻ' && $secondvowel_l == 'נ') {
					$verb_pgn = '1.c.p';
				} elseif (($firstvowel_l == 'ּ' && $secondvowel_l == 'ו')  || $firstvowel_l == 'ֻ') {
					$verb_pgn = '3.c.p';	
				} elseif ($firstvowel_l == 'י' && $thirdletter <> 'י' && $verb_type <> 'Special<br>Haya') {
					$verb_pgn = '1.c.s';	
				} elseif ($firstvowel_l == 'י' && $secondvowel_l == 'ִ') {
					$verb_pgn = '1.c.s';
				} elseif (($firstvowel_l == 'ְ' && $secondvowel_l == 'ּ' && $thirdvowel_l == 'ת') || ($firstvowel_l == 'ְ' && $secondvowel_l == 'ת') || ($firstvowel_l == 'ת' && $thirdletter <> 'ת')) {
					$verb_pgn = '2.f.s';	
				} elseif ($firstvowel_l == 'ן'  && $thirdletter <> 'ן') {
					$verb_pgn = '3.f.p';
				} elseif (($firstvowel_l == 'ָ' && $secondvowel_l == 'ּ' && $thirdvowel_l == 'ת') || ($firstvowel_l == 'ה' && $secondvowel_l == 'ָ' && $thirdvowel_l == 'ּ' && $fourthvowel_l == 'ת')  || ($firstvowel_l == 'ָ' && $secondvowel_l == 'ת') || ($firstvowel_l == 'ַ' && $secondvowel_l == 'ת') || ($firstvowel_l == 'ָ' || $firstvowel_l == 'ּ')) {
					$verb_pgn = '2.m.s';	
				} else {
					$verb_pgn = '3.m.s';
				}			
