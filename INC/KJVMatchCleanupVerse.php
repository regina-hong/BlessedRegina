...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		if (($book =='Gen' && $chapter == '32' && $verse == '1')) {
			...
			$words = $xpath_en->query("//osisText/div/chapter/verse[@osisID='".$book.".".$chapter.".".($verse-2)."']");
		} elseif (($book =='Exod' && $chapter == '22') || ($book =='Deut' && $chapter == '29') || ($book =='Isa' && $chapter == '9')) {
			$words = $xpath_en->query("//osisText/div/chapter/verse[@osisID='".$book.".".$chapter.".".($verse+1)."']");
		...
		} elseif (($book =='1Kgs' && $chapter == '5' && (((int)$verse > 0) && ((int)$verse < 15)))) {
			$temp_a = $verse+20;
			$words = $xpath_en->query("//osisText/div/chapter/verse[@osisID='1Kgs.4.".$temp_a."']");		
		} elseif ($book =='1Kgs' && $chapter == '5' && ((int)$verse > 14)) {
			$words = $xpath_en->query("//osisText/div/chapter/verse[@osisID='".$book.".".$chapter.".".($verse-14)."']");	
		} elseif (($book =='Isa' && $chapter == '8' && $verse == '23')) {
			$words = $xpath_en->query("//osisText/div/chapter/verse[@osisID='Isa.9.1"."']");		
		} else {
