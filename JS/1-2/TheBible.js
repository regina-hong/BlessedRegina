$(function(){
  ...
  $('#dynamic_select_book').on('change', function () {
      var url = "TheBible.php?book=" + $(this).val() + "&chapter=1";
  ...
  $('#dynamic_select_chapter').on('change', function () {
      ...
      var url = "TheBible.php?" + "&book=" + book + "&chapter=" + $(this).val();
      if (url) { // require a URL
          window.location = encodeURI(url); // redirect
      }
      return false;
  ...
  $('#dynamic_select_verse').on('change', function () {
      ...
      var url = "TheBible.php?" + "&book=" + book + "&chapter=" + chapter + "&verse=" + $(this).val() ;
      if (url) { // require a URL
          window.location = encodeURI(url); // redirect
      }
      return false;
