...
$query = "SELECT a.Strong_ID, b.Word, b.xlit, Count(*) as Frequency, b.Def, b.POS FROM u955934022_bible.word AS a LEFT JOIN u955934022_bible.strong AS b ON (a.Strong_ID = b.ID) WHERE b.POS = 'n-pr-m', a.Strong_ID <> '' AND b.Word <> '' GROUP BY a.Strong_ID ORDER BY b.POS DESC, Frequency DESC";
